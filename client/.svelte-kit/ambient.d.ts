...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_graphql_tag: string;
	...
	export const npm_package_dependencies__material_dom: string;
	...
	export const npm_package_dependencies__graphql_yoga_render_graphiql: string;
	export const npm_package_scripts_preview: string;
	export const npm_lifecycle_event: string;
	export const npm_package_dependencies_graphql_yoga: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_graphql_tag: string;
		...
		npm_package_dependencies__material_dom: string;
		LSCOLORS: string;
		...
		npm_package_dependencies__graphql_yoga_render_graphiql: string;
		npm_package_scripts_preview: string;
		npm_lifecycle_event: string;
		npm_package_dependencies_graphql_yoga: string;
		LANG: string;
